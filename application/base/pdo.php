...
class PdoBase
{
  ...
  function __construct($config) {
   ...
   $dsn = !empty($config['dsn']) ? $config['dsn'] : "{$config['type']}:host={$config['host']};dbname={$config['name']};charset={$config['charset']}";
	...
	$pass = !empty($config['pass']) ? $config['pass'] : NULL;
  ...
  function query_one($query=null,$params=null,$fetch_mode=null)
  {
    ...
    return $this->_query($query,$params,SQL_INIT,$fetch_mode);
  }  
	 ...
	 * @param   int $fetch_mode the fetch formatting mode
	 */    
  function _query($query,$params=null,$return_type = SQL_NONE,$fetch_mode=null)
  {
